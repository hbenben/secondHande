...
<div class="main-content">
	<div class="container">
		...
		<div class="grid">
			...
			$sql = mysql_query("select *  from shangpin where 1=1 $sqlwhere order by cishu desc limit $rsStart, $pageSize",$conn);
			...
			<div class="col-md-4 m-b">
				<a href="shopshow.php?id=<?php echo $row['id'];?>">
                	<figure class="effect-layla">
						...
						<figcaption><h4>已卖出：<?php echo $row['cishu'];?>件</h4></figcaption>
					</figure>
				</a>
				<div class="m-b-text">
