...
<div class="main-content">
	<div class="container">
		...
		<div class="grid">
			<?php
				$sql=mysql_query("select * from shangpin where tuijian=1 order by id desc limit 0,4",$conn);
...
<div class="main-content margin-2">
	<div class="container">
		...
		<div class="grid">
			<?php
				$sql=mysql_query("select * from shangpin order by addtime desc limit 0,8",$conn);
				while($row=mysql_fetch_array($sql))
				{
			?>
			<div class="col-md-3 m-b">
